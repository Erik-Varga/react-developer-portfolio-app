    ...
    <div name="home" className="relative md:h-screen w-full bg-primary dark:bg-dark-primary text-white dark:text-black z-10">
      ...
      <div className="max-w-[950px] mx-auto px-10 flex flex-col md:justify-center md:h-full">
        ...
        <div className='flex flex-wrap gap-8 my-5'>
          <div className='flex flex-col justify-center'><FcSurvey size={size*1.25} />Surveys</div>
          <div className='flex flex-col justify-center'><BsDatabaseAdd size={size*1.25} />Datasets</div>
          <div className='flex flex-col justify-center'><CgChart size={size*1.25} />Analytics</div>
          <div className='flex flex-col justify-center'><MdWebStories size={size*1.25} />Web Apps</div>
          <div className='flex flex-col justify-center'><CgRemote size={size*1.25} />Remote</div>
          <div className='flex flex-col justify-center'><FaHandshake size={size*1.25} />In-Person</div>
        </div>
        <div>
